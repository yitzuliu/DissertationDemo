...
class SmolVLM2Server:
    ...
    def generate_response(self, messages: List[Dict], max_tokens: int = 150, temperature: float = 0.7) -> Dict[str, Any]:
...
class SmolVLM2Model(BaseVisionModel):
    ...
    def predict(self, 
        ...
        try:
            ...
            result = self.server.generate_response(messages, max_tokens, temperature)
